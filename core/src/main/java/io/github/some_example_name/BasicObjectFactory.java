...
public class BasicObjectFactory implements GameObjectFactory {
    private Texture asteroidTexture;
    private Texture bulletTexture;
    public BasicObjectFactory(Texture asteroidTexture, Texture bulletTexture, ArrayList<Ball2> balls1) {
    ...
    public Ball2 createAsteroid(int x, int y, int radius, int velX, int velY) {
        return new Ball2(x, y, radius, velX, velY, asteroidTexture);
    }
